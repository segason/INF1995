...
bool bit1 = false, bit2 = false, bit3 = false, bit4 = false, bit5 = false, 
    enfonceGauche = false, enfonceDroit = false, aFaitTriangle = false, devraitFinir = false, aVuCinq = false;
uint8_t compteur = 0, petitSkip = 0, rapport = 0, nbCarre =0, nbCoins = 0;
char directions[3] = {};
Del del;
Pwm moteur;
can intensite;

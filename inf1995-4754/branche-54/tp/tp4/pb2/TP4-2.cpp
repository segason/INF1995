...
void premiereVitesse()
{
    PORTB = 0x00;
    _delay_ms(50/3);
}
void deuxiemeVitesse()
{
    PORTB = 0x00;
    _delay_ms(12.5);
    PORTB = 0x01;
...
void cinquiemeVitesse()
{
    PORTB = 0x01;
    _delay_ms(50/3);
}

void premiereVitesseQC()
{
    PORTB = 0x00;
    _delay_ms(2.5);
}
void deuxiemeVitesseQC()
{
    PORTB = 0x00;
    _delay_ms(1.875);
    PORTB = 0x01;
